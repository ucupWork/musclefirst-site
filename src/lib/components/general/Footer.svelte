    ...
    <div class="grid sm:grid-cols-2 md:grid-cols-4 gap-4 w-full h-auto justify-center items-start px-5 py-6 sm:mb-8 md:mb-16">
        ...
        <div class="sm:hidden md:block">
            ...
            >
                ...
                <a rel="noreferrer" href="http://eepurl.com/h8E589" target="_blank" class="flex justify-between items-center self-center w-full px-4 md:px-8 py-3 text-sm md:text-md bg-gradient-to-r from-amber-500 to-yellow-900 shadow shadow-yellow-200 font-black text-center text-black">
					<span class="uppercase text-yellow-900">{'Kirim Sekarang'}</span>
