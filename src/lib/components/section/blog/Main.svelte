			...
			<div class="flex flex-col w-full h-auto px-4 md:px-12">
				...
				<div class="grid grid-cols-6 gap-2 w-full h-auto">
					...
					<div class="col-span-2 md:col-span-1 w-full h-auto">
						<a href={`/blog/category/${list.slug}`} rel="norefferer" class="flex justify-center bg-transparent hover:bg-black hover:text-white items-center px-4 py-2 border border-zinc-300 rounded-full">
