...
<div class="w-full h-auto relative z-0 {$disabledScroll ? 'scroll-lock' : ''}">
    ...
    <div class="fixed bottom-2 left-1 h-auto bg-transparent w-auto z-[100] px-4 py-4">
        <div class="flex flex-col space-y-2 justify-center items-center">
            <a rel="noreferrer" href="https://wa.me/628118806632/?text=Info+Dari+Website+%3A%22Hallo%2C+Saya+tertarik+dengan+produk+Musclefirst+,+Saya+Dapat+Penawaran+Dari+Website%22&type=phone_number&app_absent=0" target="_blank" class="cursor-pointer w-14 md:w-16 h-14 md:h-16 rounded-full bg-green-500 hover:bg-green-600 shadow-lg border shadow-green-500/50 flex justify-center items-center">
